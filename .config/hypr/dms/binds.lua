...
hl.bind("ALT + V", hl.dsp.exec_cmd("codium"))
...
-- ported from niri: expel/promote focused window into its own column
...
hl.bind("ALT + SHIFT + Tab", function()
	hl.exec_cmd("hyprctl dispatch cyclenext prev")
	hl.exec_cmd("hyprctl dispatch bringactivetotop")
end)
hl.bind("ALT + grave", hl.dsp.exec_cmd("hyprctl dispatch cyclenext"))
hl.bind("ALT + SHIFT + grave", hl.dsp.exec_cmd("hyprctl dispatch cyclenext prev"))